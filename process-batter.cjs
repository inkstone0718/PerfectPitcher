...
async function processBatter() {
  try {
    const inputFile = './battingFrames.png';
    const outputPath = './public/BattingFramesTransparent.png';
    ...
    // Create a canvas for the final sprite sheet
    ...
    for (let i = 0; i < TOTAL_FRAMES; i++) {
      ...
      if (i === 1) {
        // Second frame: Mirror horizontally
        console.log(`Mirroring frame 2 (index 1)`);
      ...
      // Draw transparent frame to final canvas
    ...
    console.error('Error processing batter:', error);
  }
}
